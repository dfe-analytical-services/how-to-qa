...
author:
 - Thomas Morley
 - Thanks to Melissa Cook, James McGlade and Nicky Brassington for their help with creating this documentation
date: "`r Sys.Date()`"
...
Before discussing 'good' QA, however, it is useful to think about what it means for QA to be 'bad'.
